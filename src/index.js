...
async function onLoadMore() {
  ...
  await myApiService
    ...
    .catch(error => Notify.failure(error.name));
 ...
 * передан второй параметр, то выведем необходимое уведомление, в зависимости от запроса.
 * Если передан третий параметр, , то зададим последнюю страницу в параметр API объекта.
 * @param {Promise} data
